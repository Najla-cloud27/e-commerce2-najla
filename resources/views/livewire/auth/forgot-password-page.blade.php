        ...
        <div class="p-4 sm:p-7">
          ...
          <div class="mt-5">
            ...
            <form wire:submit.prevent='save'>
              @if (session('success'))
            <div class="mt-2 bg-green-200 border border-red-200 text-sm text-red-800 rounded-lg p-4 dark:bg-red-800/10 dark:border-red-900 dark:text-red-500 mb-4" role="alert" tabindex="-1" aria-labelledby="hs-soft-color-danger-label">
              {{ session('success') }}
            </div>
            @endif
